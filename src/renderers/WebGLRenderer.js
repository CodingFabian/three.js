...
THREE.WebGLRenderer = function ( parameters ) {
	...
	this.renderBufferDirect = function ( camera, lights, fog, material, geometry, object ) {
		...
		if ( object instanceof THREE.Mesh ) {
			...
			renderMeshDirect( material, geometry, object, program, updateBuffers );

		} else if ( object instanceof THREE.PointCloud ) {

			renderPointCloudDirect( material, geometry, object, program, updateBuffers );

		} else if ( object instanceof THREE.Line ) {

			renderLineDirect( material, geometry, object, program, updateBuffers);

		}

	};

	function renderMeshDirect ( material, geometry, object, program, updateBuffers ) {
	...
	function renderPointCloudDirect ( camera, lights, fog, material, geometry, object ) {
	...
	function renderLineDirect (  material, geometry, object ) {
